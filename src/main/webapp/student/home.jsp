...
<body>
    <div class="layui-container">
        ...
        <div class="layui-carousel" id="test1">
            <div carousel-item>
                <div>
                    <img src="https://s1.ax1x.com/2022/05/25/XkkcK1.png"/>
                </div>
                <div>
                    <img src="https://s1.ax1x.com/2022/05/25/Xkk5Pe.png"/>
                </div>
                <div>
                    <img src="https://s1.ax1x.com/2022/05/25/XkkI8H.png"/>
                </div>
            </div>
        </div>
    </div>
            ...
            success: function (res) {
                ...
                for (let i = 0; i < data.length; i++) {
                    var str = '<div class="card">\n' +
                        ...
                        '            <a class="layui-btn layui-btn-sm layui-btn-warm layui-btn-xs btn" href="${pageContext.request.contextPath}/activity/detail?aid='+data[i].aid+'">查看</a>\n' +
                        '        </div>\n' +
                        '    </div>'
                    strs += str
                }
